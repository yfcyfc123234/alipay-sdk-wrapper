...
import com.yfc.alipay.AliPayAuthResult;
import com.yfc.alipay.AliPayPayResult;
import com.yfc.alipay.R;
import com.yfc.alipay.util.OrderInfoUtil2_0;
...
public class AliPayDemoActivity extends AppCompatActivity {
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        showAlert(AliPayDemoActivity.this, getString(R.string.alipay_pay_success) + payResult);
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        showAlert(AliPayDemoActivity.this, getString(R.string.alipay_pay_failed) + payResult);
                    }
                    break;
                }
                case SDK_AUTH_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000") && TextUtils.equals(authResult.getResultCode(), "200")) {
                        ...
                        // 传入，则支付账户为该授权账户
                        showAlert(AliPayDemoActivity.this, getString(R.string.alipay_auth_success) + authResult);
                    } else {
                        // 其他状态值则为授权失败
                        showAlert(AliPayDemoActivity.this, getString(R.string.alipay_auth_failed) + authResult);
                    }
                    break;
                }
                default:
    ...
    public void payV2(View v) {
        if (TextUtils.isEmpty(APPID) || (TextUtils.isEmpty(RSA2_PRIVATE) && TextUtils.isEmpty(RSA_PRIVATE))) {
            showAlert(this, getString(R.string.alipay_error_missing_appid_rsa_private));
            return;
        }
    ...
    public void authV2(View v) {
        if (TextUtils.isEmpty(PID) || TextUtils.isEmpty(APPID)
            ...
            showAlert(this, getString(R.string.alipay_error_auth_missing_partner_appid_rsa_private_target_id));
            return;
        }
    ...
    public void showSdkVersion(View v) {
        ...
        showAlert(this, getString(R.string.alipay_alipay_sdk_version_is) + version);
    }
    ...
    public void h5Pay(View v) {
        ...
        Intent intent = new Intent(this, AliPayDemoH5Activity.class);
        Bundle extras = new Bundle();

        /*
         * URL 是要测试的网站，在 Demo App 中会使用 AliPayDemoH5Activity 内的 WebView 打开。
         *
         ...
         * 进行测试。
         *
         * AliPayDemoH5Activity 中的 MyWebViewClient.shouldOverrideUrlLoading() 实现了拦截 URL 唤起支付宝，
    ...
    private static void showAlert(Context ctx, String info, DialogInterface.OnDismissListener onDismiss) {
        new AlertDialog.Builder(ctx)
                .setMessage(info)
                .setPositiveButton(R.string.alipay_confirm, null)
